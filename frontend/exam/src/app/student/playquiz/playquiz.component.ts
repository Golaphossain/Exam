...
export class PlayquizComponent implements OnInit {
  ...
  setScore()
  {
    this.obj = {quizid:this.quizid,score: this.score}
    // console.log(this.obj);
    this.studentService.setScore(this.obj)
    //this.studentService.setScore(this.quizid, this.score)
      .subscribe(
        data => {
         // this.router.navigate(['/student/setScore']);
        },
        error =>
        {
          this.router.navigate(['/error']);
